...
<head>
	<title>
		@yield('title') - {{ config('app.name_long') }}
	</title>
	<meta charset="utf-8" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
					...
					<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
						<a href="{{ route('admin.home') }}" class="d-lg-none">
							<img alt="Logo" src="{{ $_baseurl }}assets/media/logos/default-small.svg" class="h-30px" />
						</a>
					</div>
						...
						<div class="app-navbar flex-shrink-0">
							...
							<div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
								<div class="cursor-pointer symbol symbol-30px symbol-md-40px"
									data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
									data-kt-menu-placement="bottom-end">
									<img src="{{ $_asset }}assets/media/avatars/300-1.jpg" alt="user" />
								</div>
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											<div class="symbol symbol-50px me-5">
												<img alt="Logo" src="{{ $_baseurl }}assets/media/avatars/300-1.jpg" />
											</div>
			...
			<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
				<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
					...
					<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
						...
						<!-- <a href="{{ route('admin.home') }}">
							<img alt="Logo" src="{{ $_baseurl }}assets/media/logos/default-dark.svg"
								class="h-25px app-sidebar-logo-default" />
							<img alt="Logo" src="{{ $_baseurl }}assets/media/logos/default-small.svg"
					...
					<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
						<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
							...
							<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
								...
								<!-- include('layouts.sidebar-project') -->
								<!-- todo conditional menu by role  -->
								@include('layouts.sidebar-admin')
								<!-- if($isCtxOrder || $isCtxProject)
	...
	<script src="<?= $_baseurl ?>assets/js/kts.js"></script>
